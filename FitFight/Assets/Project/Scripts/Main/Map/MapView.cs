...
namespace Map
{
    public class MapView : MonoBehaviour
    {
        ...
        public virtual void ShowMap(Map m)
        {
            ...
            EventBus<MapEvent.OnShowEvent>.Raise(new MapEvent.OnShowEvent());
        }
...
//            Debug.Log("configName: " + configName);
        ...
        {
            // Debug.Log("GetBlueprint: " + blueprintName);
            MapConfig config = GetConfig(mapManager.CurrentMap.configName);
           // Debug.Log("mapManager.CurrentMap.configName: " + mapManager.CurrentMap.configName);
